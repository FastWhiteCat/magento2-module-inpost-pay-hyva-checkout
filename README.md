# InPost Pay for Magento 2 — Hyva Checkout
...
```bash
composer require inpost/magento2-module-inpost-pay-hyva-checkout
bin/magento module:enable InPost_InPostPayHyvaCheckout
